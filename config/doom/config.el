...
(setq user-full-name "Jacob Smith"
      user-mail-address "jacob@smithjs.org")
...
(setq doom-font (font-spec :family "MonoLisaCode" :size 16 :weight medium)
      doom-variable-pitch-font (font-spec :family "MonoLisaText" :size 16 :weight medium))
...
(after! org
  (setq org-agenda-custom-commands `(("T" "Today" ((agenda "" ((org-agenda-span 'day)
